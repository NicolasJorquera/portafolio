...
function FlixerProjectPage() {
    return (
        <div className="sectionsContainers">
            ...
            <div className="flixerProjectConclusion">
                <div className="flixerProjectObjective">
                    <div className="flixerProjectObjectiveTitle">
                        Resultados
                    </div>
                ...
                <div className="videoContainer">
                    <iframe
                        src={`https://www.youtube.com/embed/8RgJNTDbUB0?autoplay=1&loop=1&controls=0&mute=1&playlist=8RgJNTDbUB0`}
                        allow="autoplay; encrypted-media"
                        title="YouTube Video as GIF"
                        className="flixerProjectVideo"
                    ></iframe>
                </div>
            </div>
